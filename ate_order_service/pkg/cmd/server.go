...
import (
	...
	"github.com/subash68/ate/ate_order_service/configuration"
	"github.com/subash68/ate/ate_order_service/pkg/logger"
	"github.com/subash68/ate/ate_order_service/pkg/protocol/grpc"
	"github.com/subash68/ate/ate_order_service/pkg/protocol/rest"
	v1 "github.com/subash68/ate/ate_order_service/pkg/service/v1"
)
...
func RunServer() error {
	...
	v1API := v1.NewOrderServiceServer(db)
