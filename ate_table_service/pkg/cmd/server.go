...
import (
	...
	"github.com/subash68/ate/ate_table_service/configuration"
	"github.com/subash68/ate/ate_table_service/pkg/logger"
	"github.com/subash68/ate/ate_table_service/pkg/protocol/grpc"
	"github.com/subash68/ate/ate_table_service/pkg/protocol/rest"
	v1 "github.com/subash68/ate/ate_table_service/pkg/service/v1"
	"strconv"
)
...
func RunServer() error {
	...
	v1API := v1.NewTableServiceServer(db)
