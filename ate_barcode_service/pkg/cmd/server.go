...
import (
	...
	"github.com/subash68/ate/ate_category_service/configuration"
	"github.com/subash68/ate/ate_category_service/pkg/logger"
	"github.com/subash68/ate/ate_category_service/pkg/protocol/grpc"
	"github.com/subash68/ate/ate_category_service/pkg/protocol/rest"
	v1 "github.com/subash68/ate/ate_category_service/pkg/service/v1"
)
...
func RunServer() error {
	...
	cfg.DatabaseHost = configuration.DbConfig().DatabaseHost
	...
	v1API := v1.NewCategoryServiceServer(db)
