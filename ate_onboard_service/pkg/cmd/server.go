...
import (
	...
	"github.com/subash68/ate/ate_onboard_service/pkg/protocol/grpc"
	"github.com/subash68/ate/ate_onboard_service/pkg/protocol/rest"
	v1 "github.com/subash68/ate/ate_onboard_service/pkg/service/v1"
)
...
func RunServer() error {
	...
	log.Print(cfg.DatabaseHost + " " + cfg.DatabasePassword + " " + cfg.DatabaseUser + " " + cfg.DatabaseSchema)
	...
	v1API := v1.NewOnboardServiceServer(db)
