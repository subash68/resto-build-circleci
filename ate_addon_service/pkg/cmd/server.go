...
import (
	...
	"github.com/subash68/ate/ate_addon_service/configuration"
	"github.com/subash68/ate/ate_addon_service/pkg/logger"
	"github.com/subash68/ate/ate_addon_service/pkg/protocol/grpc"
	"github.com/subash68/ate/ate_addon_service/pkg/protocol/rest"
	v1 "github.com/subash68/ate/ate_addon_service/pkg/service/v1"
)
...
func RunServer() error {
	...
	v1API := v1.NewAddonServiceServer(db)
