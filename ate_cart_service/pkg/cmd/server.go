...
import (
	...
	"github.com/subash68/ate/ate_cart_service/configuration"
	"github.com/subash68/ate/ate_cart_service/pkg/logger"
	"github.com/subash68/ate/ate_cart_service/pkg/protocol/grpc"
	"github.com/subash68/ate/ate_cart_service/pkg/protocol/rest"
	v1 "github.com/subash68/ate/ate_cart_service/pkg/service/v1"
)
...
func RunServer() error {
	...
	v1API := v1.NewCartServiceServer(db)
